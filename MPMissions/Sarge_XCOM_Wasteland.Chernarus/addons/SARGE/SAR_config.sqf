...
// military AI
SAR_leader_sold_list = ["BAF_Soldier_Officer_MTP"]; // the potential classes of the leader of a soldier group
SAR_sniper_sold_list = ["USMC_SoldierS_Sniper"]; // the potential classes of the snipers of a soldier group
SAR_soldier_sold_list = ["Ins_Soldier_Medic","Ins_Soldier_CO"]; // the potential classes of the riflemen of a soldier group

// bandit AI
SAR_leader_band_list = ["zetaborn_alien"]; // the potential classes of the leader of a bandit group
SAR_sniper_band_list = ["zetaborn_alien5"]; // the potential classes of the snipers of a bandit group
SAR_soldier_band_list = ["zetaborn_alien4", "zetaborn_alien2","zetaborn_13","zetaborn_alien1","zetaborn_alien7","zetaborn_alien6","zetaborn_alien3","zetaborn_alien8","zetaborn_12","zetaborn_15","zetaborn_9","zetaborn_10","zetaborn_11"]; // the potential classes of the riflemen of a bandit group

// survivor AI
SAR_leader_surv_list = ["UN_CDF_Soldier_Officer_EP1"]; // the potential classes of the leaders of a survivor group
SAR_sniper_surv_list = ["RU_Soldier_Sniper"]; // the potential classes of the snipers of a survivor group
SAR_soldier_surv_list = ["GUE_Soldier_Scout","GUE_Soldier_AT","Ins_Soldier_Sab"]; // the potential classes of the riflemen of a survivor group
...
// potential weapon list for leaders
SAR_band_leader_weapon_list = ["babe_zetaborn_rifle","babe_energy_launcher","babe_krak_launcher"];
SAR_band_leader_pistol_list = [];   

// potential item list for leaders -> Item / Chance 1 - 100
SAR_band_leader_items = [["babe_zetaborn_rifle_Mag",75],["Babe_energy_launcher_Mag",60],["babe_krak_Mag",75]];
SAR_band_leader_tools =  [["ItemMap",50],["ItemCompass",30],["Binocular_Vector",5],["NVGoggles",5],["ItemRadio",100]];

//potential weapon list for riflemen
SAR_band_rifleman_weapon_list = ["babe_zetaborn_rifle","babe_energy_launcher","babe_krak_launcher"];
SAR_band_rifleman_pistol_list = [];    

// potential item list for riflemen
SAR_band_rifleman_items = [["babe_zetaborn_rifle_Mag",75],["Babe_energy_launcher_Mag",60],["babe_krak_Mag",75]];
SAR_band_rifleman_tools = [["ItemMap",50],["ItemCompass",30],["Binocular_Vector",2],["ItemRadio",100]];

//potential weapon list for snipers
SAR_band_sniper_weapon_list = ["babe_zetaborn_rifle","babe_energy_launcher","babe_krak_launcher"];
SAR_band_sniper_pistol_list = [];   

// potential item list for snipers
SAR_band_sniper_items = [["babe_zetaborn_rifle_Mag",75],["Babe_energy_launcher_Mag",60],["babe_krak_Mag",75]];

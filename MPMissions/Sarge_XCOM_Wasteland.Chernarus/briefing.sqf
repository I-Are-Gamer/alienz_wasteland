...
player createDiarySubject ["AlienZ", "About AlienZ Mod"];
player createDiarySubject ["SargeAI", "About Sarge A.I 1.52"];
...
player createDiaryRecord["SargeAI",
[
"3.0",
"
<br/>
		About Sarge AI 1.52:<br/>
		Sarge A.I is a NPC spawner that allows you to have NPC's battle it out on the Wasteland.<br/>
		It's primary focus is to bring to life MP servers which have very few players online.<br/>
		Remember, these NPC's are enemies since they are spawning as the Aliens, so if you see an<br/>
		AlienZ, Shoot first, and don't ask questions.<br/>
		<br/>
		 Sarge A.I was actually created for DayZ. I only taken the scripts, and edited them to work with<br/>
		 the Great Mission script for Wasteland.<br/>
		<br/>		
"
]
];

player createDiaryRecord["AlienZ",
[
"3.0",
"
<br/>
		About AlienZ Mod:<br/>
		What are you doing you might ask? Pretty simple really, I wanted to give a<br/>
		reason for why this world became a wasteland in the first place. I am getting<br/>
		very tired, and very BORED of Human on Human bull MP games really, and Wasteland<br/>
		is no exception so I decided to add X-COM into the mix.<br/>
		Now you have the standard BORING West, and East but now with XCOM.<br/>
<br/>		
		--CREDITS--<br/>
		It would not have been possible without the efforts of these superheroes:<br/>
		Bad Benson | new alien model, scripts, vision, energy weapons for Zetaborn faction<br/>
		Ryan_D, Colonel26 | Aliens A1 Mod conversion for Alienz/Zetaborn Faction<br/>
		Hitcher | Spaceships & Tanks Creations used for Alienz/Zetaborn faction<br/>
		... and of course, Bohemia Interactive Studio (resource, A1/A2 models, tools, simulation)<br/>		
"
]
];		
...
<br/>
		General:<br/>
			...
			- Mobile radar now disabled for Independent X-COM teams.<br/>
			- Weapons found in cars have been adjusted.<br/>
			- 10k money limit for players.<br/>
			- Spawn beacons can be packed and destroyed by Independent players.<br/>
			MY Addition to this great addon...
			- I have replaced the Independent class with X-COM AlienZ.<br/><br/>
...
player CreateDiaryRecord["Wasteland",
[
"WELCOME TO THE WASTELAND X-COM Style",
"
 Wasteland X-COM is a MODDED version of Wasteland, and is a team versus team versus team sandbox survival experience. The objective of this mission is to rally your faction, scavenge supplies, weapons, and vehicles, and destroy the other factions. It is survival at its best!
  You will see that the Independent has been replaced by X-COM Aliens. I am still working on getting things to work with the original Wasteland. Please remember that ALL credit is due to the Wasteland Team, and the person, or persons who have worked on the AleinZ mod, I only have added the AlienZ mod into the mix.
<br/><br/>

...
switch(_selectedBox) do {
    case "mission_Mid_BAF": { // Broad selection of mid-high tier weapons 
        ...
        _currBox addWeaponCargoGlobal ["babe_zetaborn_rifle",1];
		_currBox addWeaponCargoGlobal ["babe_energy_launcher",1];
		_currBox addWeaponCargoGlobal ["babe_krak_launcher",1];
        ...
        _currBox addMagazineCargoGlobal ["babe_zetaborn_rifle_Mag",8];
		_currBox addMagazineCargoGlobal ["Babe_energy_launcher_Mag",8];
		_currBox addMagazineCargoGlobal ["babe_krak_Mag",8];
		};
    case "mission_Side_USLaunchers": { // Used in the airwreck side mission
		...
		_currBox addMagazineCargoGlobal ["Babe_energy_launcher_Mag",8];
		_currBox addMagazineCargoGlobal ["babe_krak_Mag",8];
		_currBox addMagazineCargoGlobal ["BaBe_zetaborn_Egrenade",4];
    };
